  ...
  return (
    <Card>
      <div className="mb-4 flex items-end justify-between gap-4">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">Historial de devoluciones</div>
          <h2 className="mt-2 text-xl font-black text-stone-900">Reembolsos, anulaciones y cambios</h2>
          <p className="mt-1 text-sm text-stone-500">Cada ajuste queda vinculado a la venta, el motivo, el operador, el aprobador y el recibo imprimible.</p>
        </div>
