      ...
      {open ? (
        <div className="absolute right-0 z-40 mt-3 w-[min(92vw,26rem)] rounded-[28px] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.99),rgba(248,250,252,0.97))] p-4 shadow-[0_40px_120px_-48px_rgba(28,25,23,0.55)]">
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-amber-700">Alertas</div>
              <h2 className="mt-2 text-xl font-black text-stone-950">Centro de notificaciones</h2>
              <p className="mt-1 text-sm text-stone-500">Las alertas de bajo inventario y resumen diario permanecen visibles hasta leerlas.</p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-4 space-y-2">
            {notifications.length ? (
              ...
              <div className="rounded-[24px] border border-dashed border-stone-300 bg-stone-50 p-5 text-sm text-stone-500">
                Aún no hay notificaciones. Las alertas de bajo inventario y resumen diario aparecerán aquí automáticamente.
              </div>
            )}
          </div>
        </div>
