...
import { WorkspaceHeaderProvider } from '@/components/layout/WorkspaceHeaderContext';
import WorkspaceHeaderDisplay, { WorkspaceActionsDisplay } from '@/components/layout/WorkspaceHeaderDisplay';
    ...
    <WorkspaceHeaderProvider>
      <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.18),_transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(14,165,233,0.16),_transparent_26%),linear-gradient(180deg,_#f7faf8_0%,_#eef2ec_100%)]">
        <div className="relative lg:flex">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-56 bg-[linear-gradient(180deg,rgba(255,255,255,0.30),transparent)]" />
          <AppSidebar
            shopName={shop.name}
